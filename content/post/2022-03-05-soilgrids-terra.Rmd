...
Well, almost 6 mins. It is necessary to improve the timing somehow. This process can be run in parallel with `furrr`.
...
Less than 2 minutes. As [Josh Starmer](https://www.youtube.com/channel/UCtYLUTtgS3k1Fg4y5tAhLbw) says, "BAM". Three times faster! 
